  ...
  return (
    <div className="bg-gray-100 mt-10 p-4 rounded-md h-max md:block hidden">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input type="range" min="0" max="150000" name="" id="" value={priceRange[1]} onChange={(e)=>setPriceRange([priceRange[0], Number(e.target.value), setPage(1)])} className="transition-all" />
      </div>
      <button className="bg-red-500 text-white rounded-md px-3 py-1 cursor-pointer mt-5"
      onClick={()=>{setSearch(''); setCategory("All"); setBrand("All"); setPriceRange([0,150000])}}
      >
        Reset Filters
      </button>
    </div>
