          ...
          <div className="max-w-6xl mx-auto md:p-6 grid md:grid-cols-2 grid-cols-1 gap-10">
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-xl text-red-500 font-bold">
                ₹{SingleProduct.price * 80}{" "}
                {SingleProduct.discount ? (
                  <>
                    <span className="text-gray-700 line-through">
                      ₹{OriginalPrice * 80}
                    </span>{" "}
                    <span className="bg-red-500 text-white rounded-md px-4 py-2">
              ...
              <div className="flex gap-4 mt-4">
                <button onClick={()=>addToCart(SingleProduct)} className="px-6 flex gap-2 py-2 text-lg bg-red-500 text-white rounded-md cursor-pointer items-center justify-center">
